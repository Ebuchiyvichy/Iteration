...
//кубическа€ норма матрицы — в методе простой итерации
...
//октаэдрическа€ норма матрицы — в методе простой итерации
...
//разность векторов
mytype	*diff_vector(mytype *a, mytype *b, int DIM)
{
	mytype	*c = new mytype[DIM];
...
//кубическа€ норма вектора
mytype	cube_vect_norm(mytype *x, int size)
{
	mytype	norm = 0;
...
//копирование вектора х0 в вектор х
